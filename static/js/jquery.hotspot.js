...
;(function($) {
	...
	Hotspot.prototype.setupWorkspace = function() {
      ...
      beforeClean = document.getElementsByClassName("set-img"),
      theImg = beforeClean[0],
      theImgH = theImg.clientHeight,
      theImgW = theImg.clientWidth;
	...
	Hotspot.prototype.saveData = function(data) {
		...
		// Get previous data so you can add more to it then save it again, like editing it basiaclly
		var raw_data = localStorage.getItem(this.config.LS_Variable);
    //This is the previous data, maybe I could get it from the db?
    console.log(raw_data + "rawdataaa")
		var hotspots = [];
    ...
    console.log(hotspots + "hotspotooo")
	};
