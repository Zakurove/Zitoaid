...
import * as setActions from "../../../../actions/blocks/gastro/cyto";

export class DetailsGastroC extends Component {
  constructor(props) {
    super(props);
  ...
  deleteSet(event) {
    ...
    this.props.history.push("/gastrointestinal/cytology");
  }
  ...
  onSubmit = (e) => {
    ...
    set.append("gastroCytoImage_id", this.state.selectedImageId);
  ...
  render() {
    ...
    if (this.state.redirectDelete == true) {
      return <Redirect to={"/gastrointestinal/cytology"} />;
    }
      ...
      <Fragment>
        ...
        <Fragment key={this.props.set.id}>
          ...
          <div className="row">
            <div className="col-1"></div>
            <div className="col-3">
            <Link className="btn btn-secondary " to="/gastrointestinal/cytology/" style={{ marginBottom: "3px", marginRight: "3px" }}>
            Previous Page
          </Link>
...
export default connect(mapStateToProps, mapDispatchToProps)(DetailsGastroC);
