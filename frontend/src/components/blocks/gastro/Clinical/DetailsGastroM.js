...
import { EditGastroM } from "./EditGastroM";
import { DeleteGastroM } from "./DeleteGastroM";
import styles from "react-responsive-carousel/lib/styles/carousel.min.css";
import * as setActions from "../../../../actions/blocks/gastro/clinical";

export class DetailsGastroCT extends Component {
  constructor(props) {
    super(props);
  ...
  deleteSet(event) {
    ...
    this.props.history.push("/gastrointestinal/clinicalTests");
  }
  ...
  onSubmit = (e) => {
    ...
    set.append("gastroClinicalImage_id", this.state.selectedImageId);
  ...
  render() {
    ...
    if (this.state.redirectDelete == true) {
      return <Redirect to={"/gastrointestinal/clinicalTests"} />;
    }
      ...
      <Fragment>
        ...
        <Fragment key={this.props.set.id}>
          ...
          <div className="row">
            <div className="col-1"></div>
            <div className="col-3">
            <Link className="btn btn-secondary " to="/gastrointestinal/clinicalTests/" style={{ marginBottom: "3px", marginRight: "3px" }}>
            Previous Page
          </Link>
...
export default connect(mapStateToProps, mapDispatchToProps)(DetailsGastroCT);
