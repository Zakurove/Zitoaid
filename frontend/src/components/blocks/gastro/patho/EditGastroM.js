...
import { addSet, updateSet } from "../../../../actions/blocks/gastro/clinical";
...
export class EditGastroM extends Component {
  state = {
    set: this.props.set,
...
export default connect(null, { addSet, updateSet })(EditGastroM);
