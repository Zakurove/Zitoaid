...
export class Gastro extends Component {
  render() {
    return (
      <Fragment>
        ...
        <div className="container">
          ...
          <div className="row align-items-start pt-2">
            <div className="col text-center pb-2">
              ...
              />{" "}
              <Link
                to="/gastrointestinal/microbiology"
          ...
          <div className="row align-items-center mt-2">
            ...
            <div className="col text-center">
              ...
              />
              <Link
                to="/gastrointestinal/clinicalTests"
                className="btn btn-warning stretched-link text-center"
              >
                Clinical Tests
              </Link>
