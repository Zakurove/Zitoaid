...
import { EditRespP } from "./EditRespP";
import { DeleteRespP } from "./DeleteRespP";
import styles from "react-responsive-carousel/lib/styles/carousel.min.css";
import * as setActions from "../../../../actions/blocks/resp/patho";

export class DetailsRespP extends Component {
  constructor(props) {
    super(props);
  ...
  onSubmit = (e) => {
    ...
    set.append("respPathoImage_id", this.state.selectedImageId);
...
export default connect(mapStateToProps, mapDispatchToProps)(DetailsRespP);
