...
import { addSet } from '../../../../actions/blocks/resp/patho';
...
//FilePond
 ...
 export class FormRespP extends Component {
   state = {
     title: '',
     description: '',
     ...
     onSubmit = (e) => {
       ...
       this.props.history.push('/respiratory/pathology');
       console.log("submit");
  ...
  export default connect(null, { addSet })(FormRespP);
