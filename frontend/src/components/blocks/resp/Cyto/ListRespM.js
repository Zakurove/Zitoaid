...
import { getSets, deleteSet } from "../../../../actions/blocks/resp/cyto";
import { Link } from "react-router-dom";


export class ListRespC extends Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    return (
      <div className="container">
        ...
        <Link className="btn btn-info ml-1" to="/respiratory/cytology/create/">
          Add a New Set
        </Link>
         ): ""}
        <p></p>
          ...
          <tbody>
            ...
            {this.props.sets.map((set) => (
              <tr key={set.id}>
                ...
                <td>
                  <Link
                    to={"/respiratory/cytology/" + set.id}
...
export default connect(mapStateToProps, { getSets, deleteSet })(ListRespC);
