...
// //----------------------------------------------------------------------------------------------
//                                      // NOTE SYSTEM
//   //For getting x,y of note
//   pointXY(e) {
//     this.setState({ x: e.nativeEvent.offsetX, y: e.nativeEvent.offsetY });
//   }

//   //For showing note details
//   togglePopover() {
...
//   set.append("title", this.state.set.title);
//   set.append("description", this.state.set.description);
//   // const note = new FormData();
//   set.append("noteContent", this.state.noteContent);
//   set.append("x", this.state.x);
//   set.append("y", this.state.y);
//   set.append("respMicroImage_id", this.state.selectedImageId)
//   // console.log(...note, "the new note eyy", this.state.selectedImageId)

//   // set.append('note', note)
//   console.log(...set, "eyy SET")
...
//           </Modal.Header>
//           <Modal.Body>
//             <form id="noteForm" onSubmit={this.onNoteSubmit}>
...
//                       })
//                       console.log(this.state.selectedImageId, 'id yo')
