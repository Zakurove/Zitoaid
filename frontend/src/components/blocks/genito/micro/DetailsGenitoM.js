...
import * as setActions from "../../../../actions/blocks/genito/micro";

export class DetailsGenitoM extends Component {
  constructor(props) {
    super(props);
  ...
  deleteSet(event) {
    ...
    this.props.history.push("/genitourinary/microbiology");
  }
  ...
  onSubmit = (e) => {
    ...
    set.append("genitoMicroImage_id", this.state.selectedImageId);
  ...
  render() {
    ...
    if (this.state.redirectDelete == true) {
      return <Redirect to={"/genitourinary/microbiology"} />;
    }
      ...
      <Fragment>
        ...
        <Fragment key={this.props.set.id}>
          ...
          <div className="row">
            <div className="col-1"></div>
            <div className="col-3">
            <Link className="btn btn-secondary " to="/genitourinary/microbiology/" style={{ marginBottom: "3px", marginRight: "3px" }}>
            Previous Page
          </Link>
...
export default connect(mapStateToProps, mapDispatchToProps)(DetailsGenitoM);
