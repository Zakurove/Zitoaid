...
import { addSet, updateSet } from "../../../../actions/blocks/genito/clinical";
...
export class EditGenitoM extends Component {
  state = {
    set: this.props.set,
...
export default connect(null, { addSet, updateSet })(EditGenitoM);
