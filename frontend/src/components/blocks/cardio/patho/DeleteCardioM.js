...
export class DeleteCardioM extends Component {
  state = {
    set: this.props.set,
...
// export default connect(mapStateToProps, mapDispatchToProps)(DeleteMSKM);
export default connect(null)(DeleteCardioM);
