...
import * as setActions from "../../../../actions/blocks/cardio/patho";

export class DetailsCardioP extends Component {
  constructor(props) {
    super(props);
  ...
  onSubmit = (e) => {
    ...
    set.append("cardioPathoImage_id", this.state.selectedImageId);
  ...
  render() {
    ...
    if (this.state.redirectDelete == true) {
      return <Redirect to={"/cardiology/pathology"} />;
    }
      ...
      <Fragment>
        ...
        <Fragment key={this.props.set.id}>
          ...
          <div className="row">
            <div className="col-1"></div>
            <div className="col-3">
            <Link className="btn btn-secondary " to="/cardiology/pathology/" style={{ marginBottom: "3px", marginRight: "3px" }}>
            Previous Page
          </Link>
...
export default connect(mapStateToProps, mapDispatchToProps)(DetailsCardioP);
