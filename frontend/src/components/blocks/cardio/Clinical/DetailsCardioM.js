...
import { EditCardioM } from "./EditCardioM";
import { DeleteCardioM } from "./DeleteCardioM";
import styles from "react-responsive-carousel/lib/styles/carousel.min.css";
import * as setActions from "../../../../actions/blocks/cardio/clinical";

export class DetailsCardioCT extends Component {
  constructor(props) {
    super(props);
  ...
  deleteSet(event) {
    ...
    this.props.history.push("/cardiology/clinicalTests");
  }
  ...
  onSubmit = (e) => {
    ...
    set.append("cardioClinicalImage_id", this.state.selectedImageId);
  ...
  render() {
    ...
    if (this.state.redirectDelete == true) {
      return <Redirect to={"/cardiology/clinicalTests"} />;
    }
      ...
      <Fragment>
        ...
        <Fragment key={this.props.set.id}>
          ...
          <div className="row">
            <div className="col-1"></div>
            <div className="col-3">
            <Link className="btn btn-secondary " to="/cardiology/clinicalTests/" style={{ marginBottom: "3px", marginRight: "3px" }}>
            Previous Page
          </Link>
...
export default connect(mapStateToProps, mapDispatchToProps)(DetailsCardioCT);
