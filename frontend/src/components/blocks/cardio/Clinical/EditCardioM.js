...
import { addSet, updateSet } from "../../../../actions/blocks/cardio/clinical";
...
export class EditCardioM extends Component {
  state = {
    set: this.props.set,
...
export default connect(null, { addSet, updateSet })(EditCardioM);
