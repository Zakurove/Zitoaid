...
export class DeleteHemaP extends Component {
  state = {
    set: this.props.set,
...
// export default connect(mapStateToProps, mapDispatchToProps)(DeleteHemaM);
export default connect(null)(DeleteHemaP);
