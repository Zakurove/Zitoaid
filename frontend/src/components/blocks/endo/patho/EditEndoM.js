...
import { addSet, updateSet } from "../../../../actions/blocks/endo/clinical";
...
export class EditEndoM extends Component {
  state = {
    set: this.props.set,
...
export default connect(null, { addSet, updateSet })(EditEndoM);
