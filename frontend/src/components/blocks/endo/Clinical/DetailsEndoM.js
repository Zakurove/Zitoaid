...
import { EditEndoM } from "./EditEndoM";
import { DeleteEndoM } from "./DeleteEndoM";
import styles from "react-responsive-carousel/lib/styles/carousel.min.css";
import * as setActions from "../../../../actions/blocks/endo/clinical";

export class DetailsEndoCT extends Component {
  constructor(props) {
    super(props);
  ...
  deleteSet(event) {
    ...
    this.props.history.push("/endocrine/clinicalTests");
  }
  ...
  onSubmit = (e) => {
    ...
    set.append("endoClinicalImage_id", this.state.selectedImageId);
  ...
  render() {
    ...
    if (this.state.redirectDelete == true) {
      return <Redirect to={"/endocrine/clinicalTests"} />;
    }
      ...
      <Fragment>
        ...
        <Fragment key={this.props.set.id}>
          ...
          <div className="row">
            <div className="col-1"></div>
            <div className="col-3">
            <Link className="btn btn-secondary " to="/endocrine/clinicalTests/" style={{ marginBottom: "3px", marginRight: "3px" }}>
            Previous Page
          </Link>
...
export default connect(mapStateToProps, mapDispatchToProps)(DetailsEndoCT);
