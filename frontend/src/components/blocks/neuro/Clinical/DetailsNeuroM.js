...
import { EditNeuroM } from "./EditNeuroM";
import { DeleteNeuroM } from "./DeleteNeuroM";
import styles from "react-responsive-carousel/lib/styles/carousel.min.css";
import * as setActions from "../../../../actions/blocks/neuro/clinical";

export class DetailsNeuroCT extends Component {
  constructor(props) {
    super(props);
  ...
  deleteSet(event) {
    ...
    this.props.history.push("/neurology/clinicalTests");
  }
  ...
  onSubmit = (e) => {
    ...
    set.append("neuroClinicalImage_id", this.state.selectedImageId);
  ...
  render() {
    ...
    if (this.state.redirectDelete == true) {
      return <Redirect to={"/neurology/clinicalTests"} />;
    }
      ...
      <Fragment>
        ...
        <Fragment key={this.props.set.id}>
          ...
          <div className="row">
            <div className="col-1"></div>
            <div className="col-3">
            <Link className="btn btn-secondary " to="/neurology/clinicalTests/" style={{ marginBottom: "3px", marginRight: "3px" }}>
            Previous Page
          </Link>
...
export default connect(mapStateToProps, mapDispatchToProps)(DetailsNeuroCT);
