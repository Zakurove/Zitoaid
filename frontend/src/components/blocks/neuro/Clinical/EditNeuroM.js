...
import { addSet, updateSet } from "../../../../actions/blocks/neuro/clinical";
...
export class EditNeuroM extends Component {
  state = {
    set: this.props.set,
...
export default connect(null, { addSet, updateSet })(EditNeuroM);
