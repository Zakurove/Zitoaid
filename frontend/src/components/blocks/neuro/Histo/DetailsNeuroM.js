...
import * as setActions from "../../../../actions/blocks/neuro/histo";

export class DetailsNeuroH extends Component {
  constructor(props) {
    super(props);
  ...
  deleteSet(event) {
    ...
    this.props.history.push("/neurology/Histology");
  }
  ...
  onSubmit = (e) => {
    ...
    set.append("neuroHistoImage_id", this.state.selectedImageId);
  ...
  render() {
    ...
    if (this.state.redirectDelete == true) {
      return <Redirect to={"/neurology/Histology"} />;
    }
      ...
      <Fragment>
        ...
        <Fragment key={this.props.set.id}>
          ...
          <div className="row">
            <div className="col-1"></div>
            <div className="col-3">
            <Link className="btn btn-secondary " to="/neurology/Histology/" style={{ marginBottom: "3px", marginRight: "3px" }}>
            Previous Page
          </Link>
...
export default connect(mapStateToProps, mapDispatchToProps)(DetailsNeuroH);
