...
import * as setActions from "../../../../actions/blocks/msk/micro";
...
export class DetailsMSKM extends Component {
  ...
  deleteSet(event) {
    ...
    this.props.history.push("/msk/microbiology");
  }
  ...
  onSubmit = (e) => {
    ...
    set.append("mskMicroImage_id", this.state.selectedImageId);
  ...
  render() {
    ...
    if (this.state.redirectDelete == true) {
      return <Redirect to={"/msk/microbiology"} />;
    }
      ...
      <Fragment>
        ...
        <Fragment key={this.props.set.id}>
          ...
          <div className="row">
            <div className="col-1"></div>
            <div className="col-3">
            <Link className="btn btn-secondary " to="/msk/microbiology/" style={{ marginBottom: "3px", marginRight: "3px" }}>
            Previous Page
          </Link>
