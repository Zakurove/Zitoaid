...
import * as setActions from "../../../../actions/blocks/msk/histo";
...
export class DetailsMSKH extends Component {
  ...
  deleteSet(event) {
    ...
    this.props.history.push("/msk/Histology");
  }
  ...
  onSubmit = (e) => {
    ...
    set.append("mskHistoImage_id", this.state.selectedImageId);
  ...
  render() {
    ...
    if (this.state.redirectDelete == true) {
      return <Redirect to={"/msk/Histology"} />;
    }
      ...
      <Fragment>
        ...
        <Fragment key={this.props.set.id}>
          ...
          <div className="row">
            <div className="col-1"></div>
            <div className="col-3">
            <Link className="btn btn-secondary " to="/msk/Histology/" style={{ marginBottom: "3px", marginRight: "3px" }}>
            Previous Page
          </Link>
