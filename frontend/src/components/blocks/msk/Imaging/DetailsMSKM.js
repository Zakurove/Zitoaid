...
import * as setActions from "../../../../actions/blocks/msk/imaging";
...
export class DetailsMSKI extends Component {
  ...
  deleteSet(event) {
    ...
    this.props.history.push("/msk/imaging");
  }
  ...
  onSubmit = (e) => {
    ...
    set.append("mskImagingImage_id", this.state.selectedImageId);
  ...
  render() {
    ...
    if (this.state.redirectDelete == true) {
      return <Redirect to={"/msk/imaging"} />;
    }
      ...
      <Fragment>
        ...
        <Fragment key={this.props.set.id}>
          ...
          <div className="row">
            <div className="col-1"></div>
            <div className="col-3">
            <Link className="btn btn-secondary " to="/msk/imaging/" style={{ marginBottom: "3px", marginRight: "3px" }}>
            Previous Page
          </Link>
