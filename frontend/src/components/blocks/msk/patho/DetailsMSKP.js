...
import * as setActions from "../../../../actions/blocks/msk/patho";
...
export class DetailsMSKP extends Component {
  ...
  deleteSet(event) {
    ...
    this.props.history.push("/msk/pathology");
  }
  ...
  onSubmit = (e) => {
    ...
    set.append("mskPathoImage_id", this.state.selectedImageId);
  ...
  render() {
    ...
    if (this.state.redirectDelete == true) {
      return <Redirect to={"/msk/pathology"} />;
    }
      ...
      <Fragment>
        ...
        <Fragment key={this.props.set.id}>
          ...
          <div className="row">
            <div className="col-1"></div>
            <div className="col-3">
            <Link className="btn btn-secondary " to="/msk/pathology/" style={{ marginBottom: "3px", marginRight: "3px" }}>
            Previous Page
          </Link>
